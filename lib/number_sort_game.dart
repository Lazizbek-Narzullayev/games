...
class NumberSortGameScreen extends StatefulWidget {
  const NumberSortGameScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _NumberSortGameScreenState createState() => _NumberSortGameScreenState();
}

class _NumberSortGameScreenState extends State<NumberSortGameScreen> {
  ...
  Widget build(BuildContext context) {
    // Ekran o'lchamiga mos grid o'lchami
    double gridSize =
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Raqamlarni Tartiblash'),
